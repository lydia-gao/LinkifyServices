...
def _with_db(fn):
    """Utility: provide a DB session to the wrapped function."""
...
@_with_db
def create_qrcode_task(db: Session, user_id: int, req_data: dict):
...
@_with_db
def create_barcode_task(db: Session, user_id: int, req_data: dict):
